...
ALTER TABLE "courses" ADD CONSTRAINT "courses_school_id_organization_id_fk" FOREIGN KEY ("school_id") REFERENCES "public"."organization"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
